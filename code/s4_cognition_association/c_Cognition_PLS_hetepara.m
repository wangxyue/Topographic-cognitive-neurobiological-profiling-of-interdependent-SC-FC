...
load([data_dir, 'multimod_detecres\r1w1para\hetepara_MV.mat']);
X0=hetepara_MV;
Y0=ori_Cognition;
[nSubj,node] = size(X0); 
...
hetepara_res.explCovLC = explCovLC;
hetepara_res.LC_pvals = LC_pvals;

hetepara_res.Lx = Lx;
hetepara_res.Ly = Ly;

hetepara_res.cor_perm_LxLy=cor_perm_LxLy;
hetepara_res.cor_real_LxLy=cor_real_LxLy;
hetepara_res.corr_LxLy_pvals=corr_LxLy_pvals;

hetepara_res.LC_img_loadings = corr_Lx_X; 
hetepara_res.LC_behav_loadings = corr_Ly_Y;

hetepara_res.Sp_vect = Sp_vect;
hetepara_res.LC_pvals = LC_pvals;
hetepara_res.boot_results = boot_results;

save([data_dir,'hetepara_cogres.mat'],'hetepara_res');
...
set(gca,'XLim',[0.5,10]);
set(gca,'YLim',[0.0,0.5],'YTick',0.0:0.1:0.5);
set(gca,'LineWidth',1);
